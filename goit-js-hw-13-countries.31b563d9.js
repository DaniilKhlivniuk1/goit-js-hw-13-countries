...
})({"gY3Qh":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 51465;
...
function onInput(e) {
    ...
    (0, _fetchCountriesDefault.default)(name).then((countries)=>{
        ...
        `;
        } else list.innerHTML = countries.map((c)=>`<p><img src="${c.flags.svg}" width="30" /> ${c.name.official}</p>`).join('');
    }).catch(()=>{
        (0, _core.alert)({
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","lodash.debounce":"irvaP","./fetchCountries":"bCGdT","@pnotify/core":"fay4s","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/core/dist/BrightTheme.css":"grIyt"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}]},["gY3Qh","a0t4e"], "a0t4e", "parcelRequire5a90", {})

//# sourceMappingURL=goit-js-hw-13-countries.31b563d9.js.map
